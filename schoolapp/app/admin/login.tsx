...
const TERMS_DATA = {
  service: "제1조(목적)\n본 약관은 육민관고등학교 커뮤니티 앱이 제공하는 제반 서비스의 이용조건 및 절차, 이용자의 권리와 의무 등 기본적인 사항을 규정함을 목적으로 합니다.\n\n제2조(서비스 이용)\n본 육민관 고등학교 어플리케이션의 모든 권한은 육민관고등학교 학생회에 종속되어 있으며, 어플리케이션 이용자는 본 앱을 통해 학교 공지, 급식, 건의함 등을 이용할 수 있으며, 타인을 비방하거나 부적절한 게시물을 작성할 경우 육민관 고등학교 규정에 의하여 서비스 이용 제한 및 선도위원회에 회부될 수 있습니다.",
